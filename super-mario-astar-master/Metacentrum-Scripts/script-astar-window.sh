...
RESULTDIR=/storage/brno2/home/hgandras/AIForGames/results/astarWindow
...
java -cp src mff.agents.benchmark.AgentBenchmarkMetacentrum "astarWindow" $windowOffset $maxTime
